...
import me.libraryaddict.mysql.operations.MysqlFetchCurrency;
import me.libraryaddict.mysql.operations.MysqlLoadOwned;
...
public class PlayerDataManager extends MiniPlugin
{
    ...
    public PlayerDataManager(JavaPlugin plugin, CommandManager commandManager, ServerManager serverManager)
    {
        ...
        { // Why bother when this server won't be on the main network
            new BukkitRunnable()
            {
                public void run()
                {
